...
var wrapper = function (fn) {
  return function () {
    ...
    var newFn = _.foldl(args, applier, fn);
...
var Field = Base.Field = {
  ...
  Number: wrapper(function numberField(typeOrLength, opts) {
  ...
  Enum: wrapper(function enumField(values, opts) {
  ...
  Document: wrapper(function (opts) {
    opts = opts || {};
