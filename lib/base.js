  ...
  updateSchemaVersionTable: function (callback) {
    ...
    client.query(sql, function (err, result) {
      ...
      return client.insert(schemaTable, data, function (err, result) {
        ...
        if (!err.message.match(/duplicate/i)) return callback(err, null);
        // insert failed due to duplicate key, use update instead
        client.update(schemaTable, data, { table: modelTable }, callback);
      });
    });
  }
});
