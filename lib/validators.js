...
Base.Validators = {
  ...
  Doc: function docFactory(validators) {
    function docValidator(doc, attr, debug) {
      doc = doc || {};
      attr = attr || {};
...
Base.Validators.Require.when = function requireWhenFactory(opt) {
  var field = opt['field'];
...
Base.Validators.Require.all = function requireAllValidator(obj) {
